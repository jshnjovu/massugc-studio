...
def merge_video_and_audio(
    ...
    *,
    ...
    # 1) Adjust original audio volume: [0:a]volume=original_volume[a0];
    # 2) Adjust new audio volume: [1:a]volume=new_audio_volume[a1];
    # 3) Mix them: [a0][a1]amix=inputs=2:duration=amix_duration:dropout_transition=dropout_transition[aout]
    filter_complex = (
    ...
    cmd = [
        ...
        "-map", "[aout]",       # take mixed audio from filter_complex
